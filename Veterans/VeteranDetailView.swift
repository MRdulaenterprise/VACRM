    ...
    private var claimInfoSection: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            LazyVGrid(columns: [
                ...
                InfoCard(title: "Filed Date", value: claim.claimFiledDate.formatted(date: .abbreviated, time: .omitted), icon: "calendar")
                InfoCard(title: "Days Pending", value: "\(claim.daysPending)", icon: "clock")
                InfoCard(title: "Priority", value: "Standard", icon: "exclamationmark.triangle")
                InfoCard(title: "Total Conditions", value: "\(claim.totalConditionsClaimed)", icon: "list.number")
            }
        }
    }
